...
import {GhxPaginatorModule} from '../paginator/paginator';
import {Column,Header,Footer,HeaderColumnGroup,FooterColumnGroup,PrimeTemplate} from '../../../../node_modules/primeng/components/common/shared';
import {LazyLoadEvent} from '../../../../node_modules/primeng/components/common/lazyloadevent';
import {FilterMetadata} from '../../../../node_modules/primeng/components/common/filtermetadata';
import {SortMeta} from '../../../../node_modules/primeng/components/common/sortmeta';
...
@Component({
    ...
    template: `
        <div [ngStyle]="style" [class]="styleClass" [style.width]="containerWidth"
            ...
            <ghx-paginator [rows]="rows" [first]="first" [totalRecords]="totalRecords" [pageLinkSize]="pageLinks" styleClass="ui-paginator-top" [alwaysShow]="alwaysShowPaginator"
                (onPageChange)="onPageChange($event)" [rowsPerPageOptions]="rowsPerPageOptions" *ngIf="paginator && paginatorPosition =='top' || paginatorPosition =='both'"></ghx-paginator>
            ...
            <ghx-paginator [rows]="rows" [first]="first" [totalRecords]="totalRecords" [pageLinkSize]="pageLinks" styleClass="ui-paginator-bottom" [alwaysShow]="alwaysShowPaginator"
                (onPageChange)="onPageChange($event)" [rowsPerPageOptions]="rowsPerPageOptions" *ngIf="paginator && paginatorPosition =='bottom' || paginatorPosition =='both'"></ghx-paginator>
...
@NgModule({
    imports: [CommonModule,SharedModule,GhxPaginatorModule,FormsModule],
...
export class GhxDataTableModule { }
